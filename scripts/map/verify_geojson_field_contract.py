...
KNOWN_EMPTY_NAMES = {
    "SAM-0040": "фрагмент 6,1 км² с iso_a2=CO — имени нет ни в мастере, ни в names_ru.json",
    "SAM-0055": "фрагмент 0,2 км² с iso_a2=VE — имени нет ни в мастере, ни в names_ru.json",
}

# Нулевая площадь: дефект ГЕОМЕТРИИ, а не записи. Полигон Ватикана 0,0107 км²
# при настоящих 0,44 км² (замер 2026-08-09) — `area_km2` его честно
# округляет. Правка полигона и пересчёт площади — не эта задача (T-8).
KNOWN_ZERO_AREA = {
    "EUR-0363": "Ватикан: полигон 0,0107 км² при настоящих ~0,44 — дефект геометрии, T-8",
}
