...
# ============================================================
# Австрия: 4 зоны оккупации (по федеральным землям — перепись 1951,
# ближайшая детализация к 1946; см. anchors.py::AUSTRIA_TOTAL за источник
# и назначение земель по зонам). Вена НЕ делится на секторы (решение
# пользователя 2026-07-19) — целиком идёт в советскую зону (Нижняя
# Австрия), т.к. физически анклав внутри неё.
# ============================================================
AUSTRIA_SPLIT = {
    "QOS": 1_401_000 + 276_000 + 1_616_000,  # Niederösterreich + Burgenland + Wien
    "QOA": 1_110_000 + 277_000,              # Oberösterreich + Salzburg
    "QOB": 472_000 + 1_109_000,              # Kärnten + Steiermark
    "QOF": 427_000 + 193_000,                # Tirol + Vorarlberg
}
assert sum(AUSTRIA_SPLIT.values()) == MULTI_FRAGMENT_TOTALS["AUSTRIA_TOTAL"].population
