...
SINGLE_REGION = {
    ...
    # Мальдивы (2026-07-22, класс MISSING_LAND в audit_map_geometry.py: 21 фича полностью
...
# Аральское: форма озера восстановлена (2026-07-23, reconstruct_aral_sea_
# 1946.py), но обрезка Aqtöbe/Qyzylorda/Karakalpakstan по нему — часть
# общего прохода "обрезать всю сушу по воде" (clip_land_by_water.py,
# затрагивает все континенты, не только Asia), не точечная как эти два.
CLIP_LAKE_NAMES = {
...
# класс SCATTERED в audit_map_geometry.py (разброс 17.3°) до этого фикса.
