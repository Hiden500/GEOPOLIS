...
TRANSLATE = {
    ...
    "Сен-Мартен (франц.)": "Saint Martin",
    "О. Херд и о-ва Макдональд": "Heard Island and McDonald Islands",
    ...
    "О-ва Кораллового моря": "Coral Sea Islands",
    # Тайвань (2026-07-22, пакет B): geometric-слияние (target=4) исходно
    # называло 2 крупных кластера по "победившему" по площади уезду (напр.
    # "Hsinchu" при площади в 7x больше реального Синьчжу) — переименовано
    # по географическому положению (см. rename_taiwan_clusters в
    # build_asia_1946.py). Kinmen/Penghu не тронуты (1 уезд = верное имя).
    # Счётчик в скобках — число слитых уездов, как у нетронутых английских
    # geometric-имён остальной Азии; при изменении числа уездов на будущей
    # пересборке ключ разъедется и попадёт в 'Не переведено' (не тихий сбой).
    "Северный Тайвань (17)": "Northern Taiwan",
    "Южный Тайвань (19)": "Southern Taiwan",
    # РСФСР
