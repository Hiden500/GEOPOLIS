...
SINGLE_REGION = {
    ...
    "JM": "Ямайка",
    "BS": "Багамы",
    # Французская Вест-Индия — отсутствовали вовсе (2026-07-22,
    # класс MISSING_LAND в audit_map_geometry.py). Голландская половина того же острова уже
    # выше как "Синт-Мартен" (SX) — французская часть отдельным iso_a2='MF'.
    "BL": "Сен-Бартелеми",
    "MF": "Сен-Мартен (франц.)",
}
