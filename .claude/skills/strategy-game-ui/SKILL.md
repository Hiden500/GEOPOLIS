...
- **Discovery audit**: derive scenarios, information architecture, missing
  ...
  [repository-discovery.md](../../../.agents/skills/strategy-game-ui/references/repository-discovery.md),
  [strategy-game-heuristics.md](../../../.agents/skills/strategy-game-ui/references/strategy-game-heuristics.md), and
  [ux-review.md](../../../.agents/skills/strategy-game-ui/references/ux-review.md).
- **UX specification**: turn an evidenced scenario into an implementation-ready
  ...
  [assets/templates](../../../.agents/skills/strategy-game-ui/assets/templates/README.md). Keep implementation out of scope
  unless separately requested.
- **Design-plan review**: challenge a UI-bearing plan before implementation. Read
  [design-plan-review.md](../../../.agents/skills/strategy-game-ui/references/design-plan-review.md).
- **Visual QA**: inspect screenshots or a running build at evidenced target
  viewports and inputs. Read [visual-qa.md](../../../.agents/skills/strategy-game-ui/references/visual-qa.md). If no rendered
...
Use [scenario-interface-matrix.md](../../../.agents/skills/strategy-game-ui/assets/templates/scenario-interface-matrix.md)
...
Apply the passes in [ux-review.md](../../../.agents/skills/strategy-game-ui/references/ux-review.md):
...
in [visual-qa-register.md](../../../.agents/skills/strategy-game-ui/assets/templates/visual-qa-register.md).
...
Base the report on [audit-report.md](../../../.agents/skills/strategy-game-ui/assets/templates/audit-report.md). Include:
...
Use repository reads, shell commands, image inspection, and browser automation
only when available and authorized. The skill needs no provider hooks, gstack
telemetry, Bun generation, package installation, or writes under user-home
artifact folders; do not add them.

Delegation is allowed inside the repository rules: hand independent read-only
slices to the `ui-reviewer` subagent (`.claude/agents/ui-reviewer.md`) or to
another read-only agent, never a parallel write of the same file, and reconcile
their evidence in the main report — a subagent report is a claim, not proof.
Ask the user only about material product semantics that code and docs cannot
resolve. See [sources-and-adaptation.md](../../../.agents/skills/strategy-game-ui/references/sources-and-adaptation.md).
