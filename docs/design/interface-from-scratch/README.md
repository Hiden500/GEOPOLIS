...
Рабочая ветка: `codex/interface-from-scratch`  
...
- реальная дизайн-база — сценарий 1946: 1366 регионов и 128 стран;
...
- дуги и контуры быстро превращаются в визуальный шум при 128 странах;
