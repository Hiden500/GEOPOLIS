 ...
 * ТОЛЬКО активных кризисов. Дорогая часть — вывод недовольства с разложением по
 * группам — считается для числа регионов в кризисе, а не для всего мира: при
 * полном демо-составе (~1399 регионов) выборка не превращается в сортировку
 * мира каждый ход.
 */
