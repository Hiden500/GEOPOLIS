...
const EXPECTED_COUNTRY_COUNT = 163; // Все континенты завершены (2026-07-17); 2026-07-18: Алжир→FRA (-1), Занзибар отделён (+1), Питкерн→GBR и Токелау→NZL (-2), 39 небольших колоний/морских баз без своей государственности свёрнуты в прямое владение метрополий (-39, игровое упрощение по решению пользователя); 2026-07-19: Австрия распущена на 4 зоны оккупации (-1 AUT, +4 QOS/QOA/QOB/QOF, как и Германия — по запросу пользователя).
