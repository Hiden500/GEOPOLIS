 ...
 * (docs/provenance/GOVERNMENT_1946_PROVENANCE.md: у 39 записей средняя
 * уверенность, у 7 низкая), и такой список пришлось бы переписывать при
 * каждом уточнении, ничего
