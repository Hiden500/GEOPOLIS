    ...
    <div className={styles.page}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.note}>
          Макет кликабельный: тома выдвигаются слева, реестр сортируется, клик по условной карте
          выделяет регион, правая кнопка — державу, ярлыки события ведут к месту, кнопка хода
          двигает месяц, а каждый второй ход мир поднимает кризис. Оба окна — настоящего размера,
          уменьшенные для страницы, поэтому автомасштаб и медиазапросы отрабатывают честно.
        </p>
        <p className={styles.note}>
          <a className={styles.link} href="/?showcase=screen" target="_blank" rel="noreferrer">
            Открыть макет во весь экран ↗
          </a>
        </p>
