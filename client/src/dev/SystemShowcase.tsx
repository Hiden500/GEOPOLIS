          ...
          <Panel title="Этот ход" meta="март 1946" density="flush">
            <div style={{ padding: "0 var(--space-3)" }}>
              <EventItem
                ...
                body="Черчилль говорил о железном занавесе, опустившемся от Штеттина до Триеста. Вашингтон промолчал, но не возразил. Нейтральные столицы впервые обсуждают два лагеря вслух, а не намёками."
              />
              <EventItem
                date="9 марта"
