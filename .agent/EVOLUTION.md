...
Observed problem: `server/src/llm/**` — 24 файла, 3286 строк — не входил в
область НИ ОДНОЙ роли оркестратора.
...
модели, 72 хода × три прогона при T=0. Не проходит третий критерий — «роль без
параллельной работы — церемония»: живой LLM-backlog это один пункт (перекрытие
датированных событий с прозой 84%) плюс gated-тест провайдера, ждущий квоты.
