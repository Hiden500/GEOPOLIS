...
UNKNOWN: путь «git вернул 0, каталог уцелел» воспроизвести не удалось —
во всех построенных случаях git либо отрабатывал полностью, либо падал сам и
сообщал об этом честно. Пункт 3 поэтому остаётся упрочнением без прогона на
живом отказе: он превращает необеспеченное утверждение в проверяемое, но
собственного негативного контроля у него нет.
