...
**На будущее (зафиксировано в `docs/HISTORICAL_ACCURACY.md` как
обязательный шаг):** любая правка, меняющая число выходных регионов
какой-либо азиатской страны (включая ещё не сделанный проход по Турции/
Сирии/Иордании), должна повторить этот полный snapshot+remap для
`ownership_1946.json`, а не только для explicit override-файлов.
