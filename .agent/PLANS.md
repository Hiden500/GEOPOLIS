...
разделы/файлы. После завершения план остаётся кратким evidence record либо
удаляется, если Git/каноническая документация полностью сохраняют его ценность.
